      ...
      >
        <div className="grid gap-12 md:grid-cols-2 lg:gap-16">
          ...
          <div className="space-y-6">
            <div>
              <h2 className="text-xl font-bold font-serif text-stone-900 mb-4">Herausgeber und verantwortlich für den Inhalt</h2>
            ...
            <div>
              <h2 className="text-xl font-bold font-serif text-stone-900 mb-4">Handelsregister & Steuernummern</h2>
              <div className="prose prose-stone text-stone-600">
                <p>
        ...
        <div className="mt-16 pt-16 border-t border-stone-200 space-y-8">
          <div>
            <h2 className="text-xl font-bold font-serif text-stone-900 mb-4">Haftung für Inhalte</h2>
          ...
          <div>
            <h2 className="text-xl font-bold font-serif text-stone-900 mb-4">Haftung für Links</h2>
            <p className="text-stone-600 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl font-bold font-serif text-stone-900 mb-4">Urheberrecht</h2>
            <p className="text-stone-600 leading-relaxed">
