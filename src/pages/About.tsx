import { Users, History, Award, Monitor, HeartHandshake } from 'lucide-react'
         ...
         <Section className="relative py-12 lg:py-16">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
               <div className="space-y-8">
                  <div>
                     <h2 className="text-3xl font-serif font-bold text-primary-900 mb-4">Unsere Geschichte</h2>
                  ...
                  <div className="space-y-8 relative">
                     ...
                     <div className="relative flex items-start gap-6 group">
                        ...
                        <div className="pl-12">
                           ...
                           <h3 className="text-xl font-bold text-primary-800 mt-1 mb-2">Die Gründung</h3>
                     ...
                     <div className="relative flex items-start gap-6 group">
                        ...
                        <div className="pl-12">
                           ...
                           <h3 className="text-xl font-bold text-primary-800 mt-1 mb-2">Generationswechsel</h3>
                           <p className="text-primary-700 leading-relaxed">
                     ...
                     <div className="relative flex items-start gap-6 group">
                        ...
                        <div className="pl-12">
                           ...
                           <h3 className="text-xl font-bold text-primary-800 mt-1 mb-2">Neustart</h3>
                           <p className="text-primary-700 leading-relaxed">
               ...
               <div className="relative">
                  <div className="relative rounded-2xl overflow-hidden shadow-2xl rotate-2 hover:rotate-0 transition-all duration-500">
                     ...
                     <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6 pt-20">
                        ...
                        <p className="text-white/80 text-sm">ZTM Markus Schrambke (GF) / ZTM Sven Börner (GF)</p>
                     </div>
                  </div>
         ...
         <Section background="stone" className="relative overflow-hidden py-12 lg:py-16">
            <div className="container mx-auto">
               ...
               <div className="mt-16 grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                  <Card title="Digitaler Workflow" icon={<Monitor />} className="bg-white">
                     <p className="text-primary-700 mb-4">
                        Wir können alle gängigen Datensätze verarbeiten, ob Medit, Sirona, 3Shape oder Dexis.
                     </p>
                  </Card>
                  ...
                  <Card title="Service" icon={<HeartHandshake />} className="bg-white">
                     <p className="text-primary-700 mb-4">
                        Partnerschaftlich und rund um die Uhr an Ihrer Seite – wir sind Ihr verlässlicher Support vor Ort.
                     </p>
                  </Card>
               </div>
            </div>
         ...
         <section className="py-20 bg-stone-900 text-white text-center">
            <div className="container mx-auto px-6 max-w-4xl">
               ...
               <div className="flex flex-wrap justify-center gap-4">
                  ...
                  <Button as={Link} to="/services" variant="outline" className="text-white border-white hover:bg-white hover:text-primary-900">
                     Unsere Leistungen
                  </Button>
               </div>
            </div>
